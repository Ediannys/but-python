                ...
                try:
                    ...
                    if isinstance(n_pages,int):
                        ...
                        for query in queryList:
                            try:
                                p = subprocess.Popen("xterm -e 'protonvpn-cli c -r'", stdout=subprocess.PIPE, shell=True)
                                print(query)
                                time.sleep(25)
                                ...
                                continue
                        driver.quit()
                        p = subprocess.Popen("xterm -e 'protonvpn-cli disconnect'", stdout=subprocess.PIPE, shell=True) 
                except:
